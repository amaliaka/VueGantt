        ...
        >
          <template slot-scope="scope">
            ...
            <strong v-else class="h-full">
              <span v-if="scope.row[selfProps.formatName] === 'html'">
                <a :href="scope.row[selfProps.link]" target="_blank" >{{scope.row[selfProps.name]}}</a>
              </span>
              <span v-else-if="scope.row[selfProps.formatName] === 'string'">
...
export default {
  ...
  computed: {
    ...
    ganttTitleDate() {
      ...
      // this.setDataType("monthAndDay")
      console.log(this.self_date_type)
