  ...
  <div class="ft-context-menu" v-if="flag" :style="style">
    <ul class="menu-liet" v-if="useDefault">
      ...
      >
        ...
        <div class="memu-item-value" v-html="item.value"></div>
      </li>
    ...
    flag: {
      get() {
        if (this.visible) {
          ...
          window.addEventListener("mouseover", this.watchContextmenu);
        }
        return this.visible;
      },
      set(newVal) {
  ...
  methods: {
    ...
    watchContextmenu(event) {
      if (!this.$el.contains(event.target) || event.button !== 0)
        this.flag = false;
      window.removeEventListener("mouseleave", this.watchContextmenu);
      return false;
    }
  },
  mounted() {
